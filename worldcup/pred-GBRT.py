...
for idx, teams in enumerate(matches):
    ...
    # print("features_g1:", features_g1)
    # print(type(features_g1))

    # probs_g1 = gb.predict_proba([features_g1])
    # probs_g2 = gb.predict_proba([features_g2])

    import numpy as np
    probs_1 = gb.predict([features_g1])
    probs_2 = gb.predict([features_g2])
    probs_1 = np.array(probs_1)
    probs_2 = np.array(probs_2)
    minus_1 = 1 - probs_1
    minus_2 = 1 - probs_2
    probs_g1 = np.concatenate((probs_1, minus_1), axis=0)
    probs_g2 = np.concatenate((probs_2, minus_2), axis=0)
    # print("[features_g1]:", [features_g1])
    # print(type([features_g1]))
    # print("probs_g1:", probs_g1)
    # print("probs_g2:", probs_g2)
    # print(probs_g1[0][0]+probs_g1[0][1])
    # print(type(probs_g1))
    
    team_1_prob_g1 = probs_g1[0]
    team_1_prob_g2 = probs_g2[1]
    team_2_prob_g1 = probs_g1[1]
    team_2_prob_g2 = probs_g2[0]

    team_1_prob = (probs_g1[1] + probs_g2[0])/2
    team_2_prob = (probs_g2[1] + probs_g1[0])/2
...
for p in playoffs.keys():
    if p == "16 强":
        ...
        for i in range(0, len(playoffs[p]), 1):
            ...
            team_1_prob = (probs_g1[1] + probs_g2[0])/2
            team_2_prob = (probs_g2[1] + probs_g1[0])/2
            # print("team_1_prob:", team_1_prob)
            # print("team_2_prob:", team_2_prob)
